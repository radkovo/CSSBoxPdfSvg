...
import org.fit.cssbox.svgpdf.render.PDFEngine;
...
class ImageRendererPdf
{
    ...
    public ImageRendererPdf(Dimension size)
    {
        windowSize = size;
    }
    ...
    public boolean renderURL(String urlstring, OutputStream out, String pageFormat) throws IOException, SAXException
    {
        ...
        setWindowSize(new Dimension(windowSize.width, windowSize.height), cropWindow);
    ...
    public static void main(String[] args)
    {
        ...
        try {
            ...
            ImageRendererPdf r = new ImageRendererPdf(new Dimension(1920, 1080));
